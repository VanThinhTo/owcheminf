...
from chem_inf_widgets.widgets import ow_sdf_writer as sdf_writer_widget_module
from chem_inf_widgets.widgets.ow_sdf_writer import OWSdfWriter


_APP = QApplication.instance() or QApplication([])


def test_sdf_writer_set_data_warns_when_table_preparse_fails():
    widget = OWSdfWriter()
    warnings: list[str] = []
